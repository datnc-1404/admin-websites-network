      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?controller=install&action=index" class="nav-link  active">
...
<script>
    ...
    $(document).ready(function () {
      dataTable= $('#contractTable').DataTable({
          ajax: 'index.php?controller=install&action=getInstallList',
          columns: [ 
            { data: 'id' },
            { data: 'type_net' },
            { data: 'id_contract' },
...
function deleteData(id) {
    ...
    $.ajax({
        url: 'index.php?controller=install&action=deleteInstallById',
        type: 'POST',
        data: { id: id },
