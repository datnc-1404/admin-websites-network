      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?controller=repair&action=index" class="nav-link active">
  ...
  <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">HỒ SƠ SỬA CHỮA</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                  <li class="breadcrumb-item active">Hồ sơ sửa chữa</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
...
<script>
    ...
    $(document).ready(function () {
          ...
          ajax: 'index.php?controller=repair&action=getRepairList',
          columns: [ 
            { data: 'id' },
            { data: 'name_error' },
            {
...
function deleteData(id) {
    ...
    $.ajax({
        url: 'index.php?controller=repair&action=deleteRepairById',
        type: 'POST',
        data: { id: id },
