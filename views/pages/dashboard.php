      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Danh sách lắp đặt mới</h3>
            ...
            <div class="card">
              <div class="card-header border-0">
                <h3 class="card-title">Danh sách di dời</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      <img src="../websites/assets/dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                      Some Product
                    </td>
                    <td>$13 USD</td>
                    <td>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Danh sách sửa chữa</h3>
                  <a href="javascript:void(0);">View Report</a>
                </div>
              </div>
              <div class="card-body">
            ...
            <div class="card">
              <div class="card-header border-0">
                <h3 class="card-title">Danh sách ngưng dịch vụ</h3>
                <div class="card-tools">
